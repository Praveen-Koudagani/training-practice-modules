...
class GroupServiceTest {
	...
	void testUpdateGroupName() {
		...
		assertThrows(GroupNotFoundException.class,()->groupservice.updateGroupName("googlellc","googleapps"));
	}
	...
	void testDeleteByGroupAccount() {
		...
		assertThrows(GroupNotFoundException.class,()->groupservice.deleteByGroupAccount("googlellc"));
	}
